                        ...
                        <Grid templateColumns={budgetRowsGridTemplateColumns} gridColumnGap={1} alignItems='center'>
                            <GridItem>
                                <Stack direction='row' alignItems='center' textAlign='left'>
                                    <EditableLabel
                                        ...
                                        onSubmitValue={(newValue) =>
                                            setSubCatProperty(newValue, subcategory.name, category.name, 'name')
                                        }
                                    />
                                    ...
                                    <Menu>
                                        ...
                                        <MenuList>
                                            <MenuItem
                                                onClick={() => {
                                                    setCatSubcatKey(
                                                        getCombinedCategoryString(category.name, subcategory.name)
                                                    );
                                            ...
                                            <MenuItem
                                                onClick={() => setItemToRemove([category.name, subcategory.name])}
                                            >
                                                Delete subcategory
                                            </MenuItem>
                                        </MenuList>
                                ...
                                <Progress
                                    ...
                                    colorScheme={getLinearProgressColor(
                                        subcategory.currentSpent,
                                        subcategory.totalAllotted
                                    )}
                                    mt={1}
                                />
                            </GridItem>
                            ...
                            <GridItem>
                                <EditableLabel
                                    ...
                                    onSubmitValue={(newValue) =>
                                        setSubCatProperty(newValue, subcategory.name, category.name, 'allotted')
                                    }
                                />
                            </GridItem>
                            <GridItem>
                                <Text>{getCurrencyString(subcategory.currentSpent)}</Text>
                            </GridItem>
                        </Grid>
                    </Box>
                </div>
