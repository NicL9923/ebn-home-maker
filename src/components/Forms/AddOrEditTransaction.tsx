...
const addOrEditTransactionSchema = yup.object({
...
const AddOrEditTransaction = (props: AddOrEditTransactionProps) => {
    ...
    const submitNewTransaction = async (
        transactionData: AddOrEditTransactionFormSchema,
        ...
        if (existingTransaction) {
            const existingTransactionIndex = updArr.findIndex(
                (transaction) => transaction.uid === existingTransaction.uid
            );
